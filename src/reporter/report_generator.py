...
class MarkdownReportGenerator:
    ...
    def generate_markdown(self, json_data: Dict[str, Any], analyser_type: str) -> str:
        """
    ...
    def generate_report(self, json_data: Dict[str, Any], analyser_type: str, output_file: Optional[str] = None) -> str:
        """
        Generate comprehensive markdown report from JSON data and save to file.
        ...
        markdown_content = self.generate_markdown(json_data, analyser_type)
        ...
        try:
            ...
            raise Exception(f"Failed to generate markdown report: {e}")
    ...
    def generate_markdown_report(self, json_data: Dict[str, Any], analyser_type: str, output_file: Optional[str] = None) -> str:
        """
        Legacy method name for compatibility with CLI tools.
...
class PdfReportGenerator:
    ...
    Uses MarkdownReportGenerator for content creation, then converts to PDF
    ...
    def __init__(self, reports_directory: str = "reports"):
        ...
        # Use markdown generator for content creation
        self.markdown_generator = MarkdownReportGenerator(reports_directory)
    ...
    def generate_report(self, json_data: Dict[str, Any], analyser_type: str, output_file: Optional[str] = None) -> str:
        ...
        # Generate markdown content using MarkdownReportGenerator
        markdown_content = self.markdown_generator.generate_markdown(
            json_data, analyser_type)
        ...
        try:
            ...
            converter = MarkdownToPdfConverter(
                verbose=False, page_break_mode="continuous")
