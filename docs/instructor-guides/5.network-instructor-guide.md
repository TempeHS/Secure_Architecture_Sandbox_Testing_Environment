...
- Different from code analysis - focuses on runtime network behavior
...
- What constitutes suspicious network behavior
...
- Emphasize pattern recognition over detailed analysis
