...
# Compare results
python src/analyzer/dast_cli.py http://localhost:5000 --quick > pwa_dast.txt
python src/analyzer/dast_cli.py http://localhost:9090 --quick > flask_dast.txt
```
...
Students learn to categorize DAST findings by risk level and business impact.
