...
python src/analyser/penetration_analyser.py --help
nmap --version
...
- Written acknowledgement of authorised testing environment only
...
the instructor, you MUST emphasise ethics constantly.**

#### Pre-Class Requirements (ESSENTIAL)

1. **Signed Ethics Agreement**: Every student must sign before participating
   (template provided below)
2. **Legal Explanation**: Clearly explain that unauthorised hacking is a serious
   crime
...
3. **No Real-World Testing**: Techniques ONLY used in authorised environment
4. **Professional Standards**: Teach responsible disclosure principles

**Student Ethics Agreement Template:**
```
I understand that penetration testing techniques are for authorised testing only.
...
2. **Phase 2**: Analyse automated results to prioritise manual testing targets
...
- **Time-Limited Engagements**: When clients have budget constraints, automated tools maximise coverage
...
### Phase 4: Post-Exploitation Analysis (30 minutes)

#### Learning Focus

Emphasise understanding impact rather than causing damage:
...
- **Excellent (14-15)**: Thorough understanding of legal/ethical
  responsibilities, consistent ethical behaviour
## Troubleshooting
...
4. Emphasise process over perfect results
...
**If Student Attempts Unauthorised Access:**
...
need to emphasise the human side of cybersecurity that makes these skills
