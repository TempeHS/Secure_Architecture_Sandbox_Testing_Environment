...
- **Defensive data input handling**: Identifying sanitisation and validation gaps
...
```
usage: analyse_cli.py [-h] [--demo-apps] [--tools {bandit,safety,semgrep,npm,all} ...]
                      [--output OUTPUT] [--format {json,txt,md,pdf}]
                      [--educational] [--verbose] [--quiet] [target]
...
📁 File: samples/unsecure-pwa/user_management.py
📍 Line: 89
...
📁 File: samples/unsecure-pwa/main.py
📍 Line: 522
...
- **Impact**: Database compromise, data theft, unauthorised access
- **Syllabus Connection**: Input validation and sanitisation failures
...
- **Impact**: Unauthorised system access, credential compromise
...
- **Impact**: Information disclosure, unauthorised access, system exposure
- **Syllabus Connection**: Secure application configuration and deployment

### Skills Developed

By completing this exercise, you have practised:
