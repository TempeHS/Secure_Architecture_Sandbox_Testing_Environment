...
**What is SAST?**
- Static = analyzing code without running it
...
python src/analyzer/analyze_cli.py samples/unsecure-pwa --educational | grep -i "sql"

# Save results for review
python src/analyzer/analyze_cli.py samples/unsecure-pwa --educational > results.txt
```
...
Students learn to categorize findings by severity and create actionable security recommendations.
...
- Emphasize pattern recognition over technical details
...
python src/analyzer/analyze_cli.py samples/unsecure-pwa --educational > pwa_security_results.txt
```
...
python src/analyzer/analyze_cli.py samples/unsecure-pwa --educational | grep -A 5 -B 5 "High"

# Step 3: Count different severity levels
echo "Critical Issues:"
python src/analyzer/analyze_cli.py samples/unsecure-pwa --educational | grep "High" | wc -l
echo "Medium Issues:"
python src/analyzer/analyze_cli.py samples/unsecure-pwa --educational | grep "Medium" | wc -l
```
