...
```bash
# Analyse application with educational output (primary target)
python src/analyser/analyse_cli.py samples/unsecure-pwa --educational

# Quick scan for critical vulnerabilities
python src/analyser/analyse_cli.py samples/unsecure-pwa --quick

# Generate detailed JSON report
python src/analyser/analyse_cli.py samples/unsecure-pwa --output report.json --format json
