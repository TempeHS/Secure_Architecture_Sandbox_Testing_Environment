...
```bash
# Comprehensive automated testing (prioritise PWA application)
python src/analyser/penetration_test_cli.py localhost:5000    # PWA application (primary)
python src/analyser/penetration_test_cli.py localhost:9090    # Flask application (secondary)
python src/analyser/penetration_test_cli.py localhost:3000    # Node.js application

# Quick automated vulnerability assessment
python src/analyser/penetration_test_cli.py localhost:5000 --quick

# Generate detailed report
python src/analyser/penetration_test_cli.py localhost:5000 --report > reports/pentest_$(date +%Y%m%d).txt
```
