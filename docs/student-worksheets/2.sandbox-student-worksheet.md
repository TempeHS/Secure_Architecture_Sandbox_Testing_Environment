...
Analyse suspicious script behaviour using system call tracing:

```bash
# Run suspicious script with monitoring
strace -o trace.log python samples/suspicious-scripts/suspicious_script.py
...
Monitor network behaviour of suspicious applications:
...
3. What network behaviour is suspicious? _________________
...
**3. Resource Usage:**
What resource consumption patterns indicated malicious behaviour?
_________________________________________________________________
_________________________________________________________________
...
**6. Attack Vectors:**
How might these threats reach real systems in an organisation?
_________________________________________________________________
_________________________________________________________________
...
**What was the most concerning behaviour you observed?**
_________________________________________________________________
_________________________________________________________________
...
**What skills are needed to effectively analyse suspicious applications?**
_________________________________________________________________
_________________________________________________________________

### Practical Application

**How would you implement sandbox analysis in an organisation?**
_________________________________________________________________
_________________________________________________________________
...
**How can organisations train employees about malware threats?**
_________________________________________________________________
_________________________________________________________________
computer?
...
## 🧪 Exercise 1: Basic Behavioural Analysis
...
7. **Analyse system calls for file operations**:
   ```bash
   Command to run: _________________________________________
   ```
...
8. **Analyse system calls for network operations**:
   ```bash
   Command to run: _________________________________________
   ```
...
1. **Test normal web pages**:
   ...
   ```bash
   URLs tested:
   - http://localhost:6000/ : _______________________________________________
   - http://localhost:6000/about : _________________________________________
   - http://localhost:6000/contact : _______________________________________
   ```
...
**Question**: What type of malicious software does this behaviour pattern
suggest?
...
4. **Defence Strategy**: Based on today's exercise, what defensive measures
   would you recommend for an organisation?
   ***
   ***
...
WannaCry). How would sandbox analysis help identify its malicious behaviour?
...
- Identifying malicious behaviour patterns: **\_**/5
...
**2. Privacy Rights:** What privacy concerns arise when analysing applications
...
**4. Authorised Analysis:** Why is it critical to only analyse suspicious
software in controlled, authorised environments?
...
**1. Encryption Assessment:** Did any analysed applications use encryption to
...
**1. Operational Disruption:** How would the malware behaviours you observed
...
**3. Reputation Damage:** How could malware incidents affect organisational
