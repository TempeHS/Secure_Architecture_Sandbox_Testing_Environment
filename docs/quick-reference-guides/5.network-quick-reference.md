...
### TLS/DNS Stream Visualisation

```bash
# See the actual DNS query and response (QUESTION/ANSWER sections)
dig example.com
# or, shorter output:
...
# Full TLS handshake + request/response detail (no extra tools needed)
...
- Identify unauthorised network access attempts
