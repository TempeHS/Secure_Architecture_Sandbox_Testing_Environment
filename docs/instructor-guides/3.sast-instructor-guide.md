...
python src/analyser/analyse_cli.py samples/unsecure-pwa --educational | grep "Total:"
```
...
- Most findings are labelled "High" or "Medium" severity
...
python src/analyser/analyse_cli.py samples/vulnerable-flask-app --educational | grep "Total:"
```

#### ✅ Expected Findings Students Should See:

- **Total Issues**: About 17 security problems (fewer than the Unsecure PWA)
...
data theft, and unauthorised access scenarios
